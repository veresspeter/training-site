...
describe('Service Tests', () => {
  describe('Pass Service', () => {
    ...
    let elemDefault: IPass;
    let expectedResult: IPass | IPass[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(PassService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Pass(0, currentDate, 0, currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Pass', () => {
        ...
        service.create(new Pass()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Pass', () => {
        const returnedFromService = Object.assign(
          {
            purchased: currentDate.format(DATE_FORMAT),
            usageNo: 1,
