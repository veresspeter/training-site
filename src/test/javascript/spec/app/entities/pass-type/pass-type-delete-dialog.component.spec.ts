...
describe('Component Tests', () => {
  describe('PassType Management Delete Component', () => {
    let comp: PassTypeDeleteDialogComponent;
    let fixture: ComponentFixture<PassTypeDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PassTypeDeleteDialogComponent],
      })
        .overrideTemplate(PassTypeDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(PassTypeDeleteDialogComponent);
