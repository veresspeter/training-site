...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .and()
            .featurePolicy("midi 'none'; sync-xhr 'none'; " +
            ...
            .antMatchers("/api/trainers").permitAll()
            .antMatchers("/api/pass-types").permitAll()
            .antMatchers("/api/passes/payment-callback").permitAll()
            .antMatchers("/api/application-users/{id}").hasAnyAuthority(AuthoritiesConstants.EDITOR, AuthoritiesConstants.ADMIN)
            .antMatchers("/api/application-users/internal-id/{id}").hasAnyAuthority(AuthoritiesConstants.EDITOR, AuthoritiesConstants.ADMIN)
            .antMatchers("/api/application-users/**").hasAnyAuthority(AuthoritiesConstants.ADMIN)
