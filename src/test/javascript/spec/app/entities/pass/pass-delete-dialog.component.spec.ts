...
describe('Component Tests', () => {
  describe('Pass Management Delete Component', () => {
    let comp: PassDeleteDialogComponent;
    let fixture: ComponentFixture<PassDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PassDeleteDialogComponent],
      })
        .overrideTemplate(PassDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(PassDeleteDialogComponent);
